  ...
  return (
    <div className='w-full'>
      ...
      <div className='mt-10 px-5 flex flex-col gap-y-3'>
        <Link href='/admin' className='flex gap-x-3 text-sm lg:text-lg py-4 rounded-xl items-center text-white w-full bg-[#884D80]'>
          <House className='ml-4 xl:ml-20'/>
          <p>Feed</p>
        </Link>
        <Link href='/admin/my-recipes' className='flex gap-x-3 text-sm lg:text-lg py-4 rounded-xl items-center text-white w-full bg-[#884D80]'>
          <ChefHat className='ml-4 xl:ml-20'/>
          <p>My recipes</p>
        </Link>
        <Link href='/admin/my-profile' className='flex gap-x-3 text-sm lg:text-lg py-4 rounded-xl items-center text-white w-full bg-[#884D80]'>
