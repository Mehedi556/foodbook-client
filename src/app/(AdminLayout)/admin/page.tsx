  ...
  return (
    <div className='text-colorPrimary'>
      <div className='mt-10  px-5 lg:px-20'>
        <h1 className='font-bold text-2xl text-left'>Feeds</h1>

        <form className='border p-4 md:p-10 py-5 rounded-xl mt-5 shadow'>
          <p className=' font-semibold text-base md:text-xl pb-3'>Share your recipe</p>
