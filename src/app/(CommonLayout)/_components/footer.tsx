...
const Footer = () => {
  return (
    <div className='bg-colorSecondary text-colorSolid'>
            <div className="max-w-[1280px] mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 align-items-center py-5">
                <div className='text-center sm:text-left flex flex-col items-center col-span-3 sm:col-span-1'>
                    ...
                    <div className='text-sm flex flex-col gap-y-1'>
                        <Link className='font-light text-colorSolid' href="/home">Home</Link>
                        <Link className='font-light text-colorSolid' href="/about">About us</Link>
                        <Link className='font-light text-colorSolid' href="/contact">Contact us</Link>
                        <Link className='font-light text-colorSolid' href="#">Career</Link>
                    </div>
                </div>
                ...
                <div className="col-span-3 sm:col-span-2 md:col-span-1 mt-6 sm:mt-6 md:mt-0">
                    ...
                    <h1 className='text-xs text-center text-colorSolid px-1 sm:px-3'>FoodBook is a community of food lovers, connecting home cooks and chefs through shared recipes and culinary inspiration. Your go-to hub for creative cooking ideas.</h1>
