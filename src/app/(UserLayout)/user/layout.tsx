...
import LeftSidebar from '../../(AdminLayout)/_components/LeftSidebar'
import DashboardNavbar from '../../(AdminLayout)/_components/DashboardNavbar'
import RightSidebar from '../../(AdminLayout)/_components/RightSidebar'
