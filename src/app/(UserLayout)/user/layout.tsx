...
const UserLayout = ({children}: {children: React.ReactNode}) => {
  return (
    <div className='grid grid-cols-12 bg-solid min-h-screen text-colorPrimary'>
      <div className='hidden sm:block sm:col-span-4 xl:col-span-3 sticky top-0 h-screen'>
        <LeftSidebar />
      </div>
